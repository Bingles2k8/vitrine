...
export default function DiscoverFilters({ selectedCategories, query }: {
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="relative">
        <svg className="absolute left-4 top-1/2 -translate-y-1/2 text-stone-500" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <input
          ...
          className="w-full pl-11 pr-4 py-3 bg-white/5 border border-white/10 rounded-lg text-sm text-stone-100 placeholder:text-stone-500 outline-none focus:border-white/20 transition-colors font-mono"
        />
      </div>
