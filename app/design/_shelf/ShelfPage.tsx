...
/**
 * Everything below the fold is identical across the shelf variants — only the
 * palette moves. Keeping it in one place means a new colour try is a Theme and
 * a Look, not another copy of the page.
 */
