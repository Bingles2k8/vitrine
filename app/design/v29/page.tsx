...
export const metadata = buildPageMetadata({
  title: 'Design v29 — The Store',
  description: 'Museum scene: the store room behind the gallery, one bare bulb.',
  path: '/design/v29',
  noIndex: true,
})
        ...
        <div className="pointer-events-none relative z-10 flex h-full flex-col">
          <header className="pointer-events-auto flex items-center justify-between border-b border-white/10 px-5 py-3">
            ...
            <div className="type-mono flex items-center gap-5 text-[11px] uppercase tracking-[0.12em] text-white/40">
              ...
              <Link href="/signup" className="bg-[#c9a227] px-4 py-1.5 text-[#0b0d0b] hover:bg-[#e0b93a]">
                Start free
              </Link>
            </div>
          </header>

          {/* Industrial: hard left rail, mono, a data strip instead of a subhead */}
          <div className="flex flex-1 items-center px-5 sm:px-8">
            <div className="max-w-xl border-l-2 border-[#c9a227] pl-6">
              ...
              <h1
                className="type-mono text-[2rem] font-medium leading-[1.15] tracking-[-0.01em] sm:text-[3.1rem]"
              ...
              <p
                className="mt-6 max-w-md text-[16px] leading-relaxed text-white/60"
              ...
              <dl className="mt-8 grid max-w-md grid-cols-2 gap-x-8 gap-y-2 border-t border-white/15 pt-4">
                {FACTS.map(([k, v]) => (
                  <div key={k} className="flex justify-between gap-4 border-b border-white/10 py-1.5">
                    ...
                    <dd className="type-mono text-[10px] uppercase tracking-[0.1em] text-[#c9a227]">{v}</dd>
                  </div>
                ))}
              </dl>
              ...
              <div className="pointer-events-auto mt-8 flex flex-wrap items-center gap-5">
                <Link
                  href="/signup"
                  className="type-mono bg-[#c9a227] px-8 py-3.5 text-[12px] uppercase tracking-[0.14em] text-[#0b0d0b] transition-colors hover:bg-[#e0b93a]"
                >
                  Start the register
                </Link>
      ...
      <section className="border-t border-white/10">
        <div className="mx-auto flex max-w-6xl flex-col gap-8 px-6 py-14 lg:flex-row lg:items-center lg:justify-between">
          ...
          <div className="flex flex-wrap items-center gap-5">
            ...
            <Link href="/design" className="type-mono text-[11px] uppercase tracking-[0.12em] text-white/35 underline underline-offset-4 hover:text-white">
              Back to concepts
            </Link>
          </div>
        </div>
