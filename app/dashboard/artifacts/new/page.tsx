    ...
    <div className="min-h-screen bg-stone-50 flex">
      ...
      <main className="ml-56 flex-1 flex flex-col">
        <div className="h-14 border-b border-stone-200 bg-white flex items-center gap-3 px-8 sticky top-0">
          ...
          <span className="font-serif text-lg italic text-stone-900">Add Artifact</span>
        </div>
            ...
            <div className="bg-white border border-stone-200 rounded-lg p-6 space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="A brief description for the public site…"
                  rows={4}
