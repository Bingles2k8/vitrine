      ...
      <nav className="fixed top-0 left-0 right-0 z-50 border-b border-white/5 bg-stone-950/80 backdrop-blur-md">
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link href="/login" className="bg-amber-500 hover:bg-amber-400 text-stone-950 text-sm font-mono px-4 py-2 rounded transition-colors">
              Start free →
            </Link>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto relative">
          <div className="max-w-3xl">
            ...
            <div className="flex flex-wrap items-center gap-4">
              <Link href="/login" className="bg-amber-500 hover:bg-amber-400 text-stone-950 font-mono text-sm px-6 py-3 rounded transition-colors">
                Start for free →
              </Link>
          ...
          <div className="mt-20 border border-white/8 rounded-xl overflow-hidden shadow-2xl">
            ...
            <div className="bg-stone-900 flex">
              <div className="w-44 border-r border-white/5 p-3 flex-shrink-0">
                ...
                <div className="bg-white/10 text-white text-xs font-mono px-3 py-2 rounded mb-1">⬡ Artifacts</div>
              ...
              <div className="flex-1 p-5">
                ...
                <div className="bg-white/5 rounded-lg border border-white/5 overflow-hidden">
                  <div className="grid grid-cols-4 gap-4 px-4 py-2 border-b border-white/5">
                    {['Artifact','Year','Medium','Status'].map(h => (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-5">
            {[
              ...
              },
              {
                ...
                features: ['Unlimited collection items', 'Full public website', 'Unlimited staff accounts', 'Collections compliance tools', 'Advanced analytics', 'Dedicated support'],
                missing: [],
                cta: 'Contact us →',
              ...
              <div key={p.tier} className={`rounded-xl p-8 border relative ${p.featured ? 'bg-stone-900 border-amber-500/30' : 'bg-stone-900/50 border-white/8'}`}>
                {p.featured && (
