...
Everything beyond this is a bonus. Grading integration, barcode scanning, insurance exports, and CSV import are all useful — but a tool that does these six things well beats one that half-does twenty.
