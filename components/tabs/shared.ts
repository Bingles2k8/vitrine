...
export const TREATMENT_TYPES = ['Cleaning','Restoration','Conservation','Examination','Condition Check','Other']
...
export const INVENTORY_OUTCOMES = ['Present and correct','Present — location differs','Not found']
