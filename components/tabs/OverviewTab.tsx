...
const internalLabel = <span className="ml-1 text-xs font-mono text-stone-400 dark:text-stone-500 normal-case tracking-normal">(Internal)</span>
...
export default function OverviewTab({ form, set, canEdit, saving, object, museum, latestValuation, setActiveTab }: OverviewTabProps) {
  ...
  return (
    <>
      ...
      {/* Object Information — single consolidated card */}
      <div className="bg-white dark:bg-stone-900 border border-stone-200 dark:border-stone-700 rounded-lg p-6 space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div>
            <label className={labelCls}>Currency {internalLabel}</label>
        ...
        {latestValuation && (
          <div>
            <label className={labelCls}>Latest Valuation {internalLabel}</label>
            <div className="flex items-center gap-3">
